...
class ClinicLLMService:
    ...
    async def generate_conversation_reply(
        ...
        system_prompt = (
            ...
            "Despues del primer mensaje, esta prohibido volver a saludar, decir hola o presentarte de nuevo. "
    ...
    async def generate_rag_reply(
        ...
        system_prompt = (
            ...
            "Solo el primer mensaje del hilo puede saludar. Si no es el primer intercambio, no saludes ni te presentes. "
            ...
            "Da prioridad absoluta a los fragmentos recuperados de Qdrant. Usa clinic.json solo como respaldo si el propio contexto recuperado indica que no hubo resultados. "
